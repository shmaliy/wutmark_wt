...
class Application_Model_ModelAbstract
{
    ...
    */
    ...
    /**
     * 
     * Sort menu tree by key
     * @param string $key
     * @return array
     */
    protected function _getMenuTreeSorted($key)
    {
		//TODO выполнить саму сортировку массива
    	$array = $this->_getMenuTree($this->_getMenuItems());
     ...
     */
    protected function _getCategoriesItems()
    {
    	$select = $this->_db->select();
    	$select->from(
